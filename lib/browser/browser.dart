...
import 'package:mini_vtop/browser/tab_viewer.dart';
...
class _BrowserState extends State<Browser> with SingleTickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    precacheImage(
        const AssetImage("assets/browserImages/icon/icon.png"), context);
  }
        ...
        children: browserModel.webViewTabs.map((webViewTab) {
          ...
          if (isCurrentTab) {
            Future.delayed(const Duration(milliseconds: 100), () {
              webViewTab.key2.currentState?.onShowTab();
            });
          } else {
            webViewTab.key2.currentState?.onHideTab();
          }
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            ...
            body: TabViewer(
              ...
              children: browserModel.webViewTabs.map((webViewTab) {
                webViewTab.key2.currentState?.pause();
